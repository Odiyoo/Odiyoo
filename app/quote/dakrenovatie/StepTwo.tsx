                        ...
                        return (
                            ...
                            >
                                <div
                                    ...
                                    onClick={() => {
                                        selectContractor(contractors.find((contr) => contr === contractor))
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <div className="space-y-2 text-sm">
                                                    <div className="flex justify-between">
                                                        ...
                                                        <span>€{displayPrice(formData.roofSize * 12)}</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span>Afbraakwerken (€{displayPrice(contractor.afbraakwerken_per_sq_meter)}/m²):</span>
                                            ...
                                            <div>
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    {contractor.reviews.map((review: any, index: number) => (
