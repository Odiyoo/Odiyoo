...
import { BUSINESS_NAME, CUSTOMER_SUPPORT_MAIL, CUSTOMER_SUPPORT_PHONE, FACEBOOK_LINK, INSTAGRAM_LINK } from "../business"
...
export type InquiryConfirmationMailProps = {
    inquiry: CustomerServiceInquiry,
}

export const InquiryConfirmationMail: React.FC<Readonly<InquiryConfirmationMailProps>> = async ({ inquiry }) => (
    <Tailwind
        config={config}
    >
        <Html lang="nl">
                ...
                <div className="p-8 mb-8 bg-white" style={{ backgroundColor: "white" }}>
                    <div className="space-y-6">
                        <div>
                            ...
                            <Text className="mb-4">
                                We hebben je bericht goed ontvangen. Ons support team neemt zo snel mogelijk contact met je op.
                            </Text>
                        </div>
